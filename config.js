...
// Helper: Make API call to Google Apps Script
async function callGAS(action, data = {}) {
    ...
    // Since we use no-cors, we need to handle response differently
    // You'll need to implement JSONP or use Google Apps Script's doPost with text response
